...
pub enum UiEvent {
    ...
    WifiProfilesLoaded(Vec<protocol::responses::WifiProfile>),
    WifiProfileSelectionToggled(String),
    WifiProfileSelectionCleared,
...
pub struct AppModel {
    ...
    pub wifi_profiles: Vec<protocol::responses::WifiProfile>,
...
impl Default for AppModel {
    fn default() -> Self {
        Self {
            ...
            device_name: protocol::config::DEFAULT_DEVICE_NAME.to_string(),
