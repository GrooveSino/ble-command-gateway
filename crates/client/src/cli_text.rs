...
impl Lang {
    ...
    pub(crate) fn t<'a>(&self, key: &'a str) -> &'a str {
        match (self, key) {
            ...
            (Lang::En, "alias_new_name") => "New BLE name:",
            (Lang::Zh, "alias_new_name") => "新的 BLE 名称：",
            (Lang::En, "alias_reconnect_hint") => "The current connection stays up. Scan again later to see the new advertised name.",
            (Lang::Zh, "alias_reconnect_hint") => "当前连接会保持。下次扫描才会看到新的广播名。",
